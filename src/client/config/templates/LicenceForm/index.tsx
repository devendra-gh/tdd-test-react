...
import LicenseName from 'client/config/components/LicenseName';
import ActivityGroup from 'client/config/components/ActivityGroup';
import Container from 'client/containers';
import Ownership from 'client/config/components/Ownership';
import PrivilegesFacilitiesGroup from 'client/config/components/PrivilegesFacilitiesGroup';
import AttachmentsGroup from 'client/config/components/AttachmentsGroup';
import TermsConditionsGroup from 'client/config/components/TermsConditionsGroup';
import FormGroup from 'client/config/components/FormGroup';
...
const getDefaultFormState = (user: IVariables, queryParams: IVariables) => {
  return {
    licenceType: get(queryParams, 'licenceType', ''),
          ...
          owner = [
            {
              ...
              sharePercentage: '100',
              type:
                props.user['Nationality EN'] === 'ARE' ? 'citizen' : 'resident',
    ...
    <Container locale={props.locale}>
      ...
      >
        ...
        <FormGroup name="licenceType" title={i18n('licenceType.title')}>
          ...
          {locale === 'en' ? (
            <p>
              If you are not sure which licence you need, our{' '}
              <Link
                aria-label="wizard-link"
                href="/questioner/1"
                label={i18n('questionnaire.title')}
                uiType="text"
              />{' '}
              can help.
            </p>
            ...
            <p>
              ...
              <Link
                ...
                uiType="text"
              />{' '}
              مساعدتك في تحديد الرخصة الاقتصادية المناسبة لشركتك
            </p>
          )}
        </FormGroup>
        <FormGroup
            ...
            <Col xs={12} xl={3}>
              <div className="ui-lib-margin-b_md">
                <Input
                  ...
                  help={
                    validate && formState.licenseNumber === ''
                      ? i18n('required_field')
                      : ''
                  }
                  validateStatus={
                    validate && isBranch && formState.licenseNumber === ''
                      ? 'error'
                      : null
                  }
                />
              ...
              <Col xs={12} xl={3}>
                <div className="ui-lib-margin-b_md">
                  <Select
                    ...
                    items={(() => {
                      let items = [
                        { id: '1', label: i18n('branchDetails.establishment') },
                  ...
                  <Select
                    ...
                    items={LOCATION_MATRIX['abu-dhabi-free-zones'].map(
                      (item: IVariables) => ({
                        id: item.id,
                        label:
                          props.locale === 'en' ? item.nameEn : item.nameAr,
                      }),
                    )}
              ...
              <Col xs={12} xl={3}>
                <div className="ui-lib-margin-b_md">
                  <Select
                    ...
                    disabled={branchOf(['branchUAE']) || branchOf(['branchFZ'])}
              ...
              <Col xs={12} xl={3}>
                <div className="ui-lib-margin-b_md">
                  <Input
                    ...
                    label={`${i18n('email')} *`}
                    validateStatus={
                      validate && !isEmail(formState.email) ? 'error' : null
                    }
                    help={(() => {
                      if (validate) {
                        if (formState.email === '') {
              ...
              <Col xs={12} xl={3}>
                <div className="ui-lib-margin-b_md">
                  <InputTelephone
                    ...
                    validateStatus={
                      validate && !isMobile(formState.phoneNumber)
                        ? 'error'
                        : ''
                    }
                    help={(() => {
              ...
              <Col xs={12} xl={6}>
                <div className="ui-lib-margin-b_md">
                  <Select
                    ...
                    validateStatus={
                      validate && formState.paidCapitalApprox === ''
                        ? 'error'
                        : undefined
                    }
                    help={
              ...
              <Col xs={12} xl={6}>
                <div className="ui-lib-margin-b_md">
                  <Select
                    ...
                    validateStatus={
                      validate && formState.revenuesSalesApprox === ''
                        ? 'error'
                        : undefined
                    }
                    help={
              ...
              <Col xs={12} xl={3}>
                <div className="ui-lib-margin-b_md">
                  <Select
                    ...
                    validateStatus={
                      validate && formState.durationOfTheCompany === ''
                        ? 'error'
                        : undefined
                    }
                    help={
              ...
              <Col xs={12} xl={3}>
                <div className="ui-lib-margin-b_md">
                  <Select
                    ...
                    validateStatus={
                      validate && formState.managerAppointmentDuration === ''
                        ? 'error'
                        : undefined
                    }
                    help={
              ...
              <Col xs={12} xl={3}>
                <div className="ui-lib-margin-b_md">
                  <InputNumber
                    ...
                    step={1000}
                    validateStatus={
                      validate && formState.capital === '' ? 'error' : undefined
                    }
                    roundToStepOnBlur
                    help={
                      validate && formState.capital === ''
                        ? i18n('required_field')
                        : ''
                    }
                ...
                <div className="ui-lib-margin-b_md">
                  <FileUpload
                    ...
                    files={formState.documents
                      .filter(
                        (i: IVariables) =>
                          i.fieldName === 'parentCompanyLicence',
                      )
                      .map((i: IVariables) => ({
                        file: i,
                        status: 'success',
                    ...
                    validateStatus={
                      validate && !isUploaded('parentCompanyLicence')
                        ? 'error'
                        : ''
                    }
                ...
                <div className="ui-lib-margin-b_md">
                  <FileUpload
                    ...
                    help={
                      branchOf(['branchFZ', 'branchUAE'])
                        ? `${i18n(
                            'branchDocuments.parentCompanyMoaDocument',
                          )} *`
                        : `${i18n(
                    ...
                    validateStatus={
                      validate && !isUploaded('parentCompanyMoaDocument')
                        ? 'error'
                        : ''
                    }
              ...
              <Col xs={12} xl={2}>
                <div className="ui-lib-margin-b_md">
                  <FileUpload
                    ...
                    validateStatus={
                      validate && !isUploaded('freezoneNoc') ? 'error' : ''
                    }
              ...
              <Col xs={12} xl={6}>
                <div className="ui-lib-margin-b_md">
                  <FileUpload
                    ...
                    validateStatus={
                      validate && !isUploaded('noBranchAD') ? 'error' : ''
                    }
        ...
        {formState.licenceType !== 'instant' && locationGroup}
        <FormGroup
        ...
        >
          ...
          {formState.licenceType === 'mubdia' &&
            formState.activities.length > 1 && (
              <div className="ui-lib-margin-b_md">
                <Alert
                  message={i18n('activities_error_length')}
                  status="error"
                />
              </div>
            )}
            ...
            <Col xs={12} xl={3}>
              <div className="ui-lib-margin-b_md">
                <Input
                  ...
                  validateStatus={
                    validate && !isEmail(formState.officialEmail)
                      ? 'error'
                      : null
                  }
                  help={(() => {
            ...
            <Col xs={12} xl={3}>
              <div className="ui-lib-margin-b_md">
                <InputTelephone
                  ...
                  validateStatus={
                    validate && !isMobile(formState.officialMobile)
                      ? 'error'
                      : ''
                  }
                  help={(() => {
              ...
              <Col xs={12} xl={3}>
                <div className="ui-lib-margin-b_md">
                  <InputTelephone
                    ...
                    validateStatus={
                      validate && !isMobile(formState.contactPersonPhone)
                        ? 'error'
                        : ''
                    }
                    help={(() => {
          ...
          <Row gutter={20} flex>
            <Col xs={12}>
              <Checkbox
                ...
                name="confirmation"
                validateStatus={
                  validate && !formState.confirmation ? 'error' : ''
                }
            ...
            <Col xs={12} xl={3}>
              <div className="ui-lib-margin-b_md">
                <Input
                  ...
                  validateStatus={
                    validate && !isEmail(formState.applicantEmail)
                      ? 'error'
                      : null
                  }
                  help={(() => {
            ...
            <Col xs={12} xl={3}>
              <div className="ui-lib-margin-b_md">
                <InputTelephone
                  ...
                  validateStatus={
                    validate && !isMobile(formState.applicantPhoneNumber)
                      ? 'error'
                      : ''
                  }
                  help={(() => {
        ...
        >
          ...
          <Checkbox
            ...
            validateStatus={
              validate && !formState.termsConditions ? 'error' : ''
            }
          />
        </FormGroup>
