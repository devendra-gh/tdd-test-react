...
import CustomComponent from 'client/components/workbench/v4/CustomComponent';
import Space from 'client/components/workbench/main/Space';
import GridComponent from 'client/components/workbench/v4/GridComponent';
import Flexbox from 'client/components/workbench/v4/Flexbox';
