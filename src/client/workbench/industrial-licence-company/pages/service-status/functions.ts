...
export async function f2_onClick(props: any) {
  ...
  basePath = `/services/business/ded/industrial-licence-company/`;
  ...
  window.location.href = `${host}/services/business/ded/api/smartpass/logout${logoutType}?redirectUrl=${host}${basePath}enter-trade-name`;
}
