...
const pageConfig = [
  {
    title: 'Awaiting payment page',
    pageId: 'kKhWhxn6FNVbN6GoZ-88I',
    expanded: true,
      ...
      definitions: [
        {
          ...
          props: {
            status: 'inProgress',
            icon: null,
            title: "i18n('AwaitingPayment_Title')",
            tags: '${state.individualIssuedTags}',
            content: "i18n('AwaitingPayment_Desc')",
            buttons: [],
            space: {
              marginBottom: 'lg',
            },
        ...
        {
          componentId: 'hpfDZkHSWB6xDqe5FFCnw',
          type: 'button',
          props: {
            locale: 'en',
            label: "i18n('AwaitingPayment_RetryButton')",
            type: 'button',
            uiType: 'primary',
            disabled: false,
            'aria-label': 'button',
          ...
          layout: 'base',
          sharedProps: ['i18n', 'locale', 'paymentURL'],
        },
      ],
      symbols: [
        {
    ...
    fromProcessState: {
      ...
      variables: ['submitDate', 'renewalNumber'],
    },
  },
];
