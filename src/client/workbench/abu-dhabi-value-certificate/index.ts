...
import page4 from './pages/enter-company-details';
import page5 from './pages/upload-document';
import page6 from './pages/contact-details';
import page7 from './pages/application-inprogress';
import page8 from './pages/review-quotations';
import page9 from './pages/application-returned';
import page10 from './pages/licence-issued';
import page11 from './pages/error';
...
const config = {
  version: '156',
  appName: 'Request for Abu Dhabi Value Certificate',
  defaults: {
    title: 'Request for Abu Dhabi Value Certificate',
  },
  initialState: {
    paymentTableColumns: [],
    paymentTableRows: [],
